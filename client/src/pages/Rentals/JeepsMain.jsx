...
const ListVehicle = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const jeeps = res.data.filter(vehicle => vehicle.vehiclecategory === 'jeep'); // Filter only jeeps
        setVehicles(jeeps); // Set the list of jeeps
      } catch (err) {
  ...
  return (
    <div className="container mx-auto p-4">
      <h2 className="text-2xl font-bold mb-4">List of Jeeps</h2>
