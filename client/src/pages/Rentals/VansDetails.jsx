...
const ImageList8 = [
    {
        id: 17,
        href: "../../pages/Rentals/VansDetails",
            ...
            <div className='container px-4 mx-auto max-w-3xl py-32'>
                ...
                <div className=' mt-8 flex justify-between'>
                    <div className="mt-5 px-4 sm:px-0">
                        <div className="text-base font-semibold leading-7 text-gray-900">Caravan DFR-7863</div>
                ...
                <div className="mt-6 border-t border-gray-100">
                    <dl className="divide-y divide-gray-100">
                        ...
                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                            ...
                            <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">Two Sliding Doors (02) and Two Doors (02)</dd>
                        </div>
                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
